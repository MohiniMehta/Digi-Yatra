...
const FLIGHT_SUGGESTIONS = [
  ...
  },
  {
    code: 'BLR',
    city: 'Bengaluru',
    airport: 'Kempegowda Internatinal Airport',
  },
  ...
  },
  {
    code: 'AMD',
    city: 'Ahmedabad',
    airport: 'Sardar Vallabhai Patel International Airport',
  },
    ...
    <Grid container spacing={2} alignItems="center">
      ...
      alignItems: 'flex-end', 
          ...
          <Button
            ...
            sx={{
              background: 'linear-gradient(to right, #9c27b0, #e91e63)', // Smooth gradient from purple to pink
              transition: 'background-color 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms, box-shadow 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms, border-color 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms, color 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms',
              color: 'white',
              '&:hover': {
                background: 'linear-gradient(to right, #7b1fa2, #d81b60)', // Darker gradient on hover
              }
            }}
          >
            SELECT
