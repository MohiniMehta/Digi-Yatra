...
export const BoardingPass = () => {
  ...
  const canDownload = state?.checkInStatus?.person1Verified && 
                     ...
                     console.log("Check-in Status:", state?.checkInStatus);
            ...
            <Grid container>
              ...
              <Grid item xs={12} md={4}>
                <Box sx={{ p: 3, bgcolor: 'grey.50' }}>
                  ...
                  <Typography variant="body2" sx={{ fontSize: '1.25rem', textAlign: 'center', }}>
                    {pass.passenger.firstName} {pass.passenger.lastName}
                  </Typography>
                  <Typography variant="body2" sx={{ fontSize: '1.25rem', textAlign: 'center', }}>
                    Seat: {pass.passenger.seat}
                  </Typography>
                  <Typography variant="body2" sx={{ fontSize: '1.25rem' , textAlign: 'center', mb:3}}>
