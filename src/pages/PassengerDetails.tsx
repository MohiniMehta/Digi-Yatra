    ...
    try {
      ...
      if (webcamRef.current) {
        ...
        if (imageSrc) {
          ...
          // ✅ Log images in the console
          console.log('Person 1 Images:', updatedFormData.person1.images.map(img => img.dataUrl));
          console.log('Person 2 Images:', updatedFormData.person2.images.map(img => img.dataUrl));
                  ...
                  <Box sx={{ 
                    ...
                    {isCameraOpen ? (
                      ...
                      <Box sx={{ 
                        ...
                        <Box sx={{
                           width: '120px',  // Increased for full-circle coverage
                           height: '120px',
                           borderRadius: '50%',
                           overflow: 'hidden',
...
<img src="/rotateface.gif" alt="Rotate face guide"   style={{
        width: '100%', 
        height: '100%', 
        objectFit: 'cover' // Ensures full-circle appearance
      }}  />
    ...
    {Array.from({ length: MAX_CAPTURES }).map((_, index) => {
      ...
      return (
        <Grid item xs={2} key={`capture-slot-${index}`}>
          <Box sx={{ 
            position: 'relative',
